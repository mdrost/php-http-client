...
/**
 * @covers Mdrost\HttpClient\Exception\RequestException
 */
class RequestExceptionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCreatesGenerateException()
    {
        ...
        $this->assertInstanceOf('Mdrost\HttpClient\Exception\RequestException', $e);
    }
    ...
    public function testCreatesClientErrorResponseException()
    {
        ...
        $this->assertInstanceOf('Mdrost\HttpClient\Exception\ClientException', $e);
    }
    ...
    public function testCreatesServerErrorResponseException()
    {
        ...
        $this->assertInstanceOf('Mdrost\HttpClient\Exception\ServerException', $e);
    }
    ...
    public function testWrapsRequestExceptions()
    {
        ...
        $this->assertInstanceOf('Mdrost\HttpClient\Exception\RequestException', $ex);
